...
#    @test_throws ArgumentError("Repeated junction ID: .") initJunctionsTestRepId()
    @test_throws ArgumentError("Junction with ID 1 isolated.") initJunctionsTestIsolated()
#    @test_throws ArgumentError("Junction with ID 1 of type T has 2 ends. It should have 3 ends.") initJunctionsTestWrongType()
